...
import { OrganizerValidation } from "@/app/(root)/competitions/organizers/[organizerId]/components/organizer-form";
...
const OrganizerModal = ({ isOpen, onClose }: Props) => {
  ...
  const title = "Erstelle einen neuen Veranstalter!";
